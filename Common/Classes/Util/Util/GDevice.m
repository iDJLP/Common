...
{
    NSString *platform = [self platformSystem];
    
    NSDictionary *platIphone = @{
@"iPhone1,1": @"iPhone 1G",
@"iPhone1,2": @"iPhone 3G",
...
@"iPad7,4": @"iPad Pro 10.5-inch (WiFi/Cellular)"};
    ...
    return platIphone[platform] ?: platform;
}

+ (NSString *) platformSimple
{
    NSString *platformString = [self platformFull];
