...
+ (NSString *)mj_localizedStringForKey:(NSString *)key value:(NSString *)value
{
    ...
    NSString *language = [FTConfig sharedInstance].lang;
    if (bundle == nil||![lang isEqualToString:language]) {
        ...
        bundle = [NSBundle bundleWithPath:[[NSBundle mj_refreshBundle] pathForResource:userLanguage ofType:@"lproj"]];
        lang = language;
    }
