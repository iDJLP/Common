...
/**
 ...
 <tr><td>"icon"      </td><td>1     </td></tr>
 <tr><td>"icon@2x"   </td><td>2     </td></tr>
 <tr><td>"icon@2.5x" </td><td>2.5   </td></tr>
...
/**
 Create a string from the file in main bundle (similar to [GColorUtil imageNamed:]).
