...
typedef NS_ENUM(NSInteger, HMSegmentedControlSelectionStyle) {
    ...
    HMSegmentedControlSelectionStyleStationary//自己添加的固定宽度
};
...
@property (nonatomic, copy) IndexClickBlock indexClickBlock;
...
- (void)setIndexClickBlock:(IndexClickBlock)indexClickBlock;
