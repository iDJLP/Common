...
- (void)commonInit {
    ...
    _backgroundColor = [GColorUtil C6];
    self.opaque = NO;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        } else if (self.selectionStyle == HMSegmentedControlSelectionStyleStationary && self.segmentWidthStyle != HMSegmentedControlSegmentWidthStyleDynamic){
            CGFloat widthToEndOfSelectedSegment = (self.segmentWidth * self.selectedSegmentIndex) + self.segmentWidth;
            CGFloat widthToStartOfSelectedIndex = (self.segmentWidth * self.selectedSegmentIndex);
            sectionWidth = 14;
                         ...
                         notify:(BOOL)notify
{
    ...
    if (index == HMSegmentedControlNoSegment) {
        ...
        if (animated) {
            ...
            self.selectionIndicatorStripLayer.frame = [self frameForSelectionIndicator];
            if (self.selectionStyle == HMSegmentedControlSelectionStyleStationary) {
                self.selectionIndicatorStripLayer.cornerRadius = 1.0f;
            }
            self.selectionIndicatorBoxLayer.frame = [self frameForFillerSelectionIndicator];
