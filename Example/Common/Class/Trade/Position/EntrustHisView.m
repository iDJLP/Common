...
@interface EntrustHisView ()<UITableViewDelegate,UITableViewDataSource>
...
- (instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style{
    if (self = [super initWithFrame:frame style:style]) {
        ...
        [self registerClass:EntrustHisCell.class forCellReuseIdentifier:@"EntrustHisCell"];
        WEAK_SELF;
...
- (void)requestData:(BOOL)isRefresh
{
    ...
    [DCService getQueryEntrustHis:_params page:page success:^(id data) {
...
{
    WEAK_SELF;
    EntrustHisCell *cell = [tableView dequeueReusableCellWithIdentifier:@"EntrustHisCell"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [EntrustHisCell heightOfCell:[NDataUtil dataWithArray:_dataList index:indexPath.row]];
}
